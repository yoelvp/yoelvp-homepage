...
export default function CategoryMenu() {
  return (
    <Menu
      ...
      aria-label='menu'
    >
      <Menu.Button className="inline-flex justify-center items-center gap-2 rounded-md border border-zinc-400 dark:border-zinc-400 p-2 text-sm font-bold shadow-sm hover:bg-orange-200 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-secondary dark:focus:ring-primary focus:ring-offset-2 focus:ring-offset-gray-100 transition-all duration-300">
        Categorias
        <BiSolidCategory />
      </Menu.Button>
            ...
            {({ active }) => (
              <a
                ...
                className={`
                  ...
                  white-to-secondary dark:white-to-primary
                `}
              >
                Todos
              </a>
